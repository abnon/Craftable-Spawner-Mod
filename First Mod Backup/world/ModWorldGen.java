package com.organicapple.craftablespawnermod.world;

import java.util.Random;

import com.organicapple.craftablespawnermod.init.ModBlocks;
...
public class ModWorldGen implements IWorldGenerator {
	...
	private void generateOverworld(Random rand, int chunkX, int chunkZ, World world, IChunkGenerator chunkGenerator, IChunkProvider chunkProvider) {
		...
		// add blocks here
		generateOre(ModBlocks.OPAL_ORE.getDefaultState(), world, rand, chunkX*16, chunkZ*16, 16, 64, rand.nextInt(3)+1, 18);
	}
